...
#			}
		...
		if (plots) {
			...
			par(mar = c(6,6,5,3))
			cat(" MA-plot...\n")
			out.l$MAplots[[contr]] <- diff_expr_ma_plot(d3, contr, id="ID", sym.col, p.thr, fdr.thr, logfc.thr, numlab, out.dir, analysis.name, point.lab, biom.attributes, font.size, lists)

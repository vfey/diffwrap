...
diffr_pheatmap = function(expr.mat, clinical.mat,
  ...
  if (missing(clinical.mat)) {
    ...
    if (!biserial.fl) {
      ...
      p = pheatmap::pheatmap(expr.mat,
                             ...
                             cellwidth = cell.size, cellheight = cell.size, fontsize = font.size,
                             fontsize_row = cell.size, fontsize_col = cell.size, silent = TRUE,
                             main = paste0("Heatmap of genes over samples (", add.main, ")"))
      ...
      p = pheatmap::pheatmap(expr.mat,
                             ...
                             annotation = clinical.mat, breaks = breaks.hm,
                             cellwidth = cell.size, cellheight = cell.size, fontsize = font.size,
                             fontsize_row = cell.size, fontsize_col = cell.size, silent = TRUE, main = paste0("Heatmap of genes over samples (", add.main, ")"))
  ...
  heatmap.list[["correlogram"]] = correlogram_pheatmap(t_data_heat_map, clinical.mat, scale.fl = scale.fl, signif.stars.fl = signif.stars.fl, main.correl = paste0("Gene Correlogram (", add.main, ")"))
  ...
  heatmap.list[["correlogram.small"]] = correlogram_pheatmap(t_data_heat_map, clinical.mat, scale.fl = scale.fl, signif.stars.fl = signif.stars.fl,
                                                             main.correl = paste0("Gene Correlogram (", add.main, ")"),  cell.size =  cell.new, font.size = font.new)
  ...
  heatmap.list[["correlogram.sample"]] = correlogram_pheatmap(as.matrix(expr.mat), clinical.mat, scale.fl = scale.fl, signif.stars.fl = signif.stars.fl,
                                                              main.correl = paste0("Sample Correlogram (", add.main, ")"), sample.correl = TRUE, cell.size =  cell.new, font.size = font.new)
